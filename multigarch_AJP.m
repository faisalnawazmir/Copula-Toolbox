function [parameters, likelihood, stderrors, robustSE, ht, scores]=multigarch_AJP(data,p,o,q,type,errors,options,startingvals)
% PURPOSE:
...
% NOTE: I changed just one line below (line 159) to change how starting values are obtained. This seemed to work better in the applications I had (but
% may not be better everywhere).  -Andrew Patton
...
%startingvalues(1:1+p+q+o)=tarch(data,p,o,q,'TARCH',[],newoptions);  % AJP: switching this off 23mar11
