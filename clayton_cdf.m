...
if nargin<3 || isempty(k1)  % allowing for matrix input on first argument, and parameter as second argument
    k1 = v;
    v = u(:,2);
    u = u(:,1);
end
...
% 19oct04: Clayton cop is well defined at theta=0, (it is the "independence copula" but it is a limiting case. 
